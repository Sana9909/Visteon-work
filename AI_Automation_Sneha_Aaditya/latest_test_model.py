...
def main():
    # ==============================================================================
    BASE_MODEL_DIR   = r"C:\Sneha\models\Llama-3.2-3B-Instruct-bnb-4bit"
    FINETUNED_ADAP   = r"C:\Sneha\AI_Automation\output\llama-3.2-3b-instruct-bnb-4bit\vhal_parser_model"
    INPUT_TXT_FILE   = "latest_testing.txt"
    OUTPUT_JSON_FILE = "test_results_output.json"
    MAX_LEN          = 2048
    # ==============================================================================
