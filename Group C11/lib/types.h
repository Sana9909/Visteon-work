...
#define CLAMP_NONE  (0U)
#define CLAMP_SPEED (1U << 0U)
#define CLAMP_TEMP  (1U << 1U)
#define CLAMP_GEAR  (1U << 2U)
#define CLAMP_MODE  (1U << 3U)
...
typedef struct {
    ...
    /* Deferred error reporting fields */
    uint8_t     clamping_flags;
    int16_t     invalid_speed;
    int16_t     invalid_temperature;
    int8_t      invalid_gear;
} VehicleStatus;
